...
const plans = [
  { name: 'ESSENTIAL', price: 'R7,500', intro: 'A polished online presence, ready to launch.', features: ['Up to 3 pages', 'Professional website design', 'Mobile responsive', 'Contact form + WhatsApp', 'Basic SEO', '12 months hosting', 'Free .co.za domain for 12 months'] },
  { name: 'LAUNCH', price: 'R13,700', intro: 'A custom professional website built around your business.', features: ['Up to 5 professionally designed pages', 'Custom visual direction', 'Mobile-first responsive build', 'Custom page layouts', 'Contact + enquiry forms', 'WhatsApp integration', 'Basic SEO', '12 months hosting', 'Free .co.za domain for 12 months', '5 professional business email accounts', '12 months email service'] },
  { name: 'GROWTH', price: 'R18,500', intro: 'For businesses ready to generate more from their website.', features: ['Up to 10 professionally designed pages', 'Content structure & page planning', 'Custom visual design', 'Conversion-focused page structure', 'SEO foundations', 'Google Analytics & lead tracking', 'Performance optimisation', 'Advanced contact/enquiry forms', '12 months hosting', 'Free .co.za domain for 12 months', '5 professional business email accounts', '12 months email service'], featured: true },
  { name: 'SIGNATURE', price: 'R32,000+', intro: 'For brands requiring a fully bespoke digital experience.', features: ['Bespoke strategy + UX planning', 'Custom design system', 'Fully bespoke interface', 'Advanced functionality', 'E-commerce & third-party integrations', 'API integrations', 'Advanced SEO architecture', 'Analytics & conversion tracking', 'Performance optimisation', '12 months hosting', 'Free .co.za domain for 12 months', '5 professional business email accounts', 'Priority technical support'], note: 'Advanced web applications, booking platforms, customer portals, marketplaces and complex software systems are quoted separately according to technical requirements and project scope.' },
]

const process = ['A good conversation', 'A clear direction', 'A first impression', 'The build', 'The handover', 'A long-term home']

const faqs = [
  ['How much does a website cost?', 'Projects start from R7,500 for a focused business website. Larger websites, ecommerce, integrations and strategy are quoted according to scope.'],
  ...
  return (
    <main className="site-shell">
      ...
      <nav className={`nav-wrap ${scrolled ? 'is-scrolled' : ''}`} aria-label="Primary navigation">
        ...
        <div className="nav-end"><a className="online" href="#plans" aria-label="Go to website investment section"><i /> INVESTMENT</a><a className="nav-whatsapp" href={whatsappUrl} target="_blank" rel="noreferrer" onClick={handleWhatsAppClick} aria-label="Chat with SihleB on WhatsApp">CHAT</a><a className="nav-cta" href="#contact">START A PROJECT <ArrowUpRight size={14} /></a></div>
